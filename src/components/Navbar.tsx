...
const navigation = [
    { name: 'Home', to: '/'},
    { name: 'Activate Tracking', to: '/activate-tracking' },
    { name: 'View Tracking', to: '/view-tracking' },
]
                ...
                <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                    <div className="flex lg:flex-1">
                        <a href="#" className="-m-1.5 p-1.5">
                            <span className="sr-only">TrackEase</span>
                            <img
                    ...
                    <div className="hidden lg:flex lg:flex-1 lg:justify-end">
                        <a href="http://localhost:8000/parcel/api/v1/docs/" className="hover:text-[#a96c46] text-sm font-semibold leading-6 text-gray-900">
                            Api Documentation <span aria-hidden="true">&rarr;</span>
                        </a>
                    </div>
                </nav>
